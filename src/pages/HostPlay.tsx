...
// // import { getOptionStyle } from '@/lib/quizUtils';
...
// //     // Fetch leaderboard data after a short delay
// //     setTimeout(async () => {
...
// //             onClick={handleNext}
// //             size="lg"
// //             className="w-full text-lg animate-bounce-in"
// //           >
...
// //         {/* Question Display */}
// //         <Card className="p-12 text-center bg-gradient-to-br from-primary/10 to-accent/10 border-2 border-primary">
// //           <h2 className="text-5xl font-bold mb-8">{currentQuestion.text}</h2>

// //           {!delayComplete ? (
// //             <div className="text-2xl text-muted-foreground animate-pulse">
// //               Question starting in 5 seconds...
// //             </div>
// //           ) : !showResults && (
...
// //                   <div
// //                     className={`w-16 h-16 rounded-full flex items-center justify-center text-3xl text-white ${style.bgClass}`}
// //                   >
// //                     {style.icon}
// //                   </div>
// //                   <div className="flex-1 text-left">
// //                     <div className="font-semibold text-lg">{style.name}</div>
// //                     <div className="text-xl">{option.text}</div>
// //                   </div>
...
// // I've added this here to make the component work standalone,
// // as the new design relies heavily on it.
// // You can move this to '@/lib/quizUtils' if you already have it.
...
//         {/* Right: Time */}
//         <div className="text-right">
//            <div className="text-sm font-medium text-muted-foreground mb-1">Time Limit</div>
...
//             </div>
//           ) : (
//              <div className="text-4xl font-bold text-accent animate-bounce-in">
//               Time's Up!
//             </div>
//           )}
//         </div>
